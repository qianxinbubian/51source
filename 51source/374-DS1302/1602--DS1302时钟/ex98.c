...
{	
   ...
   WriteSet1302(0x80,0x55);   //根据写秒寄存器命令字，写入秒的初始值
   WriteSet1302(0x82,0x59);   //根据写分寄存器命令字，写入分的初始值
	WriteSet1302(0x84,0x12); //根据写小时寄存器命令字，写入小时的初始值
	WriteSet1302(0x86,0x28); //根据写日寄存器命令字，写入日的初始值
	WriteSet1302(0x88,0x01); //根据写月寄存器命令字，写入月的初始值
	WriteSet1302(0x8c,0x16);   //根据写小时寄存器命令字，写入小时的初始值
} 
/*******************************************************************************
以下是对液晶模块的操作程序
*******************************************************************************/
